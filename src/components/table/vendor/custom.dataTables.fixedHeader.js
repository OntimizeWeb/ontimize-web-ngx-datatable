...
(function (factory) {
	...
	var FixedHeader = function (dt, config) {
		...
		var container = this._getContainer(dt);
		this.c.headerOffset = $(container).offset().top;
	...
	$.extend(FixedHeader.prototype, {
		...
		_scroll: function (forceChange) {
			...
			var container = this._getContainer(this.s.dt);
