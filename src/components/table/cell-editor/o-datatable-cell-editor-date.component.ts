...
@Component({
  ...
  template: '',
  inputs: [
    ...DEFAULT_INPUTS_O_DATATABLE_CELL_EDITOR_DATE
  ],
  outputs: [
    'onFocus',
    'onBlur',
...
export class ODataTableCellEditorDateComponent implements OnInit, ITableCellEditor {
  ...
  protected dialogRef: MdDialogRef<ODataTableCellEditorDateDialog>;
  ...
  protected openDialog(data: any) {
    ...
    this.dialogRef = this.ng2Dialog.open(ODataTableCellEditorDateDialog, cfg);
